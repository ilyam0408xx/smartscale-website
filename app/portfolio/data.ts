...
export const hero = {
  ...
  lead: 'אוטומציות Make, מערכות SaaS שנבנו מאפס, ו-CRM שמריץ קליניקות. וגם: חברה שלמה שמנוהלת ע״י צבא של סוכני AI.',
}

export const stats: Stat[] = [
  { num: '9', label: 'שנות ניסיון עם בעלי עסקים', sub: '' },
...
export const caseStudy: CaseStudy = {
  ...
  techBreakdown: [
    ...
    'בלב המערכת: סוכן AI שמתזמר את כל הזרימה ומחליט מה קורה בכל שלב, עם היגיון שמסתגל.',
...
export const reacherful: Reacherful = {
  ...
  metrics: [
    ...
    { value: '$3', label: 'ל-100 לידים בממוצע' },
    { value: '×4', label: 'שיעור מענה מול שיווק קר (25%)' },
  ],
  ...
  flow: [
    ...
    { step: 'שליחה / ייצוא', desc: 'שליחה ישירה מהכלי (IG · WhatsApp · LinkedIn) או ייצוא לקובץ' },
  ],
  architecture: [
    'ארכיטקטורת SaaS מלאה, מוצר שלם end-to-end',
    ...
    'שליחה ישירה רב-ערוצית מתוך הכלי + בקרת תקציב',
  ],
  image: '/portfolio/scraper.png', // סקרינשוט הממשק של Reacherful
...
export const proofItems: ProofItem[] = [
  ...
  { title: 'GHL', field: 'הגירת מערכת', desc: 'פרויקט מעבר ובניית בוטים ב-GoHighLevel.' },
