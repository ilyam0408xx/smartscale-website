    ...
    >
      ...
      >
        <div style={{ maxWidth: 680 }}>
          ...
          >
            אני איליה מלצב, ובניתי את Smart Scale כדי לבנות מערכות אוטומציה
            לעסקים ישראליים. התחלתי לעבוד בגיל 14, צברתי 7+ שנות ניסיון,
            ובניתי כלים שחוסכים לבעלי עסקים עשרות שעות עבודה בשבוע.
          </p>
          <p
            style={{
              fontSize: 16,
