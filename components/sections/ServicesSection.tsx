      ...
      >
        <div style={{ marginBottom: 40 }}>
          ...
          <p className="direct-answer">
            אני בונה מערכות שמחליפות את העבודה הידנית החוזרת — כל ליד מקבל
            מענה תוך 2 דקות, תזכורות יוצאות לבד, ומסמכים מסתדרים אוטומטית.
            עסקים שעובדים עם המערכות שאני בונה חוסכים בממוצע 15 שעות עבודה
            בשבוע.
          </p>
        </div>
